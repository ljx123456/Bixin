...
class Lead11Activity: BaseActivity(){
    ...
    override fun initActivityData() {
        image_lead.setImageResource(R.mipmap.lead_default_11)
        image_lead2.setImageResource(R.mipmap.lead_11)
        var h= Handler()

...
class Lead10Activity: BaseActivity(){
    ...
    override fun initActivityData() {
        image_lead.setImageResource(R.mipmap.lead_default_10)
        image_lead2.setImageResource(R.mipmap.lead_10)
        var h= Handler()

package com.example.shadow.heartrecreation.utils.zxing.android;
...
import com.example.shadow.heartrecreation.utils.zxing.camera.CameraManager;
import com.example.shadow.heartrecreation.utils.zxing.view.ViewfinderView;
...
//            Toast.makeText(this, "扫描成功", Toast.LENGTH_SHORT).show();
            ...
            Map<String,String> map= UrlParse.getUrlParams(result);
...
//            intent.putExtra("codedBitmap", barcode);
                ...
                com.example.shadow.heartrecreation.utils.utils.Toast.INSTANCE.Tips("请扫描正确的二维码");

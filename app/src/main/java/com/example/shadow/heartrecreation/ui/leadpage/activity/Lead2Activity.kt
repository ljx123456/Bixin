...
class Lead2Activity:BaseActivity(){
    ...
    override fun initActivityData() {
        image_lead.setImageResource(R.mipmap.lead_default_2)
        image_lead2.setImageResource(R.mipmap.lead_2)
        var h=Handler()

...
class Lead12Activity: BaseActivity(){
    ...
    override fun initActivityData() {
        image_lead.setImageResource(R.mipmap.lead_default_12)
        image_lead2.setImageResource(R.mipmap.lead_12)
        var h= Handler()

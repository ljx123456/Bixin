...
class Lead6Activity: BaseActivity(){
    ...
    override fun initActivityData() {
        image_lead.setImageResource(R.mipmap.lead_default_6)
        image_lead2.setImageResource(R.mipmap.lead_6)
        var h= Handler()

...
class Lead15Activity: BaseActivity(){
    ...
    override fun initActivityData() {
        image_lead.setImageResource(R.mipmap.lead_default_15)
        image_lead2.setImageResource(R.mipmap.lead_15)
        var h= Handler()

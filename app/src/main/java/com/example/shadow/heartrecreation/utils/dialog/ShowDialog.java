...
public class ShowDialog {
     ...
     * @return
     */
    public static void showCustomDialog(Context context, String title, String message, String positiveButtonText, String negativeButtonText, boolean flag, DialogInterface.OnClickListener listener, View.OnClickListener click) {
        CustomDialog.Builder builder = new CustomDialog.Builder(context);
        builder.setTitle(title).setMessage(message).setPositiveButton(positiveButtonText, listener).setNegativeButton(negativeButtonText, listener).setQuestion(flag).setQuestButton(click).create().show();
    }
}

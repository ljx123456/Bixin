...
class Lead8Activity: BaseActivity(){
    ...
    override fun initActivityData() {
        image_lead.setImageResource(R.mipmap.lead_default_8)
        image_lead2.setImageResource(R.mipmap.lead_8)
        var h= Handler()

...
class Lead0Activity:BaseActivity(){
    ...
    override fun initActivityData() {
        image_lead.setImageResource(R.mipmap.lead_default_1)
        image_lead2.setImageResource(R.mipmap.lead_0)
        var h=Handler()

package com.example.shadow.heartrecreation.jpush;
...
import com.example.shadow.heartrecreation.ui.main.activity.MainActivity;
...
public class NotificationUtils extends ContextWrapper {
    ...
    public Notification.Builder getChannelNotification(String title, String content) {
        Intent intent = new Intent(this, MeassageActivity.class);
    ...
    public void sendNotification(String data) {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            Notification notification = getChannelNotification
                    ("比心娱乐", "data.getContent()").build();
            getManager().notify(1, notification);
        } else {
            Notification notification = getNotification_25("比心娱乐", "data.getContent()").build();
            getManager().notify(1, notification);
        }
    }
}

...
public class ImagePreview {
    ...
    private List<VideoModel> imageInfoList;// 图片数据集合
    ...
    public List<VideoModel> getImageInfoList() {
        return imageInfoList;
    }

    public ImagePreview setImageInfoList(@NonNull List<VideoModel> imageInfoList) {

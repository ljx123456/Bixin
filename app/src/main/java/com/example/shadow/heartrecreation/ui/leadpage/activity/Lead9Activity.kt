...
class Lead9Activity: BaseActivity(){
    ...
    override fun initActivityData() {
        image_lead.setImageResource(R.mipmap.lead_default_9)
        image_lead2.setImageResource(R.mipmap.lead_9)
        var h= Handler()

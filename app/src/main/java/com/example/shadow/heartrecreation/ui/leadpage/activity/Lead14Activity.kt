...
class Lead14Activity: BaseActivity(){
    ...
    override fun initActivityData() {
        image_lead.setImageResource(R.mipmap.lead_default_14)
        image_lead2.setImageResource(R.mipmap.lead_14)
        var h= Handler()

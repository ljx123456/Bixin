package com.example.shadow.heartrecreation.notification
...
import com.example.shadow.heartrecreation.db.user.getJMID
import com.example.shadow.heartrecreation.db.user.getUserID
import com.example.shadow.heartrecreation.jpush.NotificationUtils
...
//                var intent=Inten
//            }
//            var intent = Intent(context, MessageListActivity::class.java)
...
//            return
        ...
        val mIntent = Intent(context, MeassageActivity::class.java)

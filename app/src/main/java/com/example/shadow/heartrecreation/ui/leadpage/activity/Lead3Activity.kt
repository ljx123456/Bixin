...
class Lead3Activity: BaseActivity(){
    ...
    override fun initActivityData() {
        image_lead.setImageResource(R.mipmap.lead_default_3)
        image_lead2.setImageResource(R.mipmap.lead_3)
        var h= Handler()
